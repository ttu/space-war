...
export type MissilePhase = 'boost' | 'coast' | 'terminal';
...
export interface Missile extends Component {
  ...
  totalFuel: number;            // initial fuel budget (for reserve calculation)
  ...
  launchX: number;               // km — launch position (for arming check)
  launchY: number;
